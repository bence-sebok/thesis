...
// if_freq: -406250.0
// nb_filter: 3
// nb_filter_bw: 80.26416666666667
// wb_filter: 3
// wb_filter_bw: 80.26416666666667
...
#define RADIO_CONFIG_SET_PROPERTY_PREAMBLE_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                                                             */,\
  0x04 /* START_PROP                                                                                                            */,\
  0x31 /* PREAMBLE_CONFIG,RX_PREAM_SRC[7],PREAM_FIRST_1_OR_0[5],LENGTH_CONFIG[4],MAN_CONST[3],MAN_ENABLE[2],STANDARD_PREAM[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_PKT_FIELD_2_CRC_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                                                        */,\
  0x14 /* START_PROP                                                                                                       */,\
  0x2A /* PKT_FIELD_2_CRC_CONFIG,SEND_CRC[5],SEND_ALT_CRC[4],CHECK_CRC[3],CHECK_ALT_CRC[2],CRC_ENABLE[1],ALT_CRC_ENABLE[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_PKT_FIELD_3_CRC_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                                                        */,\
  0x18 /* START_PROP                                                                                                       */,\
  0x00 /* PKT_FIELD_3_CRC_CONFIG,SEND_CRC[5],SEND_ALT_CRC[4],CHECK_CRC[3],CHECK_ALT_CRC[2],CRC_ENABLE[1],ALT_CRC_ENABLE[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_PKT_RX_FIELD_1_CRC_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                                                             */,\
  0x24 /* START_PROP                                                                                                            */,\
  0x00 /* PKT_RX_FIELD_1_CRC_CONFIG,CRC_START[7],ALT_CRC_START[6],CHECK_CRC[3],CHECK_ALT_CRC[2],CRC_ENABLE[1],ALT_CRC_ENABLE[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_PKT_RX_FIELD_3_CRC_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                               */,\
  0x2C /* START_PROP                                                                              */,\
  0x00 /* PKT_RX_FIELD_3_CRC_CONFIG,CHECK_CRC[3],CHECK_ALT_CRC[2],CRC_ENABLE[1],ALT_CRC_ENABLE[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MATCH_CTRL_1 { \
  ...
  0x01 /* NUM_PROPS                                        */,\
  0x02 /* START_PROP                                       */,\
  0x00 /* MATCH_CTRL_1,POLARITY[7],MATCH_EN[6],OFFSET[4:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MATCH_VALUE_3 { \
  ...
  0x01 /* NUM_PROPS                  */,\
  0x06 /* START_PROP                 */,\
  0x00 /* MATCH_VALUE_3,VALUE_3[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MATCH_VALUE_4 { \
  ...
  0x01 /* NUM_PROPS                  */,\
  0x09 /* START_PROP                 */,\
  0x00 /* MATCH_VALUE_4,VALUE_4[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MATCH_CTRL_4 { \
  ...
  0x01 /* NUM_PROPS                                     */,\
  0x0B /* START_PROP                                    */,\
  0x00 /* MATCH_CTRL_4,POLARITY[7],LOGIC[6],OFFSET[4:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_INTE { \
  ...
  0x01 /* NUM_PROPS                   */,\
  0x00 /* START_PROP                  */,\
  0x41 /* FREQ_CONTROL_INTE,INTE[6:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_FRAC { \
  ...
  0x03 /* NUM_PROPS                                       */,\
  0x01 /* START_PROP                                      */,\
  0x0C /* FREQ_CONTROL_FRAC,FRAC[3:0],FRAC[7:0],FRAC[7:0] */,\
  0xEC /* DATA1                                           */,\
  0x4E /* DATA2                                           */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_CHANNEL_STEP_SIZE { \
  ...
  0x02 /* NUM_PROPS                                                                    */,\
  0x04 /* START_PROP                                                                   */,\
  0x4E /* FREQ_CONTROL_CHANNEL_STEP_SIZE,CHANNEL_STEP_SIZE[7:0],CHANNEL_STEP_SIZE[7:0] */,\
  0xC5 /* DATA1                                                                        */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_VCOCNT_RX_ADJ { \
  ...
  0x01 /* NUM_PROPS                                     */,\
  0x07 /* START_PROP                                    */,\
  0xFE /* FREQ_CONTROL_VCOCNT_RX_ADJ,VCOCNT_RX_ADJ[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DECIMATION_CFG0 { \
  ...
  0x01 /* NUM_PROPS                                                                            */,\
  0x1F /* START_PROP                                                                           */,\
  0x20 /* MODEM_DECIMATION_CFG0,CHFLT_LOPW[7],DROOPFLTBYP[6],DWN3BYP[5],DWN2BYP[4],RXGAINX2[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_LIMITER { \
  ...
  0x02 /* NUM_PROPS                                 */,\
  0x30 /* START_PROP                                */,\
  0x0F /* MODEM_AFC_LIMITER,AFCLIM[6:0],AFCLIM[7:0] */,\
  0x50 /* DATA1                                     */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_MISC { \
  ...
  0x01 /* NUM_PROPS                                                                                                                  */,\
  0x32 /* START_PROP                                                                                                                 */,\
  0xC0 /* MODEM_AFC_MISC,ENAFCFRZ[7],ENFBPLL[6],EN2TB_EST[5],ENFZPMEND[4],ENAFC_CLKSW[3],OOK_ZEROG[2],NON_FRZEN[1],LARGE_FREQ_ERR[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_RFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x39 /* START_PROP                           */,\
  0x47 /* MODEM_AGC_RFPD_DECAY,RFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_IFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x3A /* START_PROP                           */,\
  0x47 /* MODEM_AGC_IFPD_DECAY,IFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_FSK4_GAIN0 { \
  ...
  0x01 /* NUM_PROPS                                           */,\
  0x3C /* START_PROP                                          */,\
  0x02 /* MODEM_FSK4_GAIN0,PHASE_COMP_2FSK[7],4FSK_GAIN0[6:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_RSSI_CONTROL2 { \
  ...
  0x01 /* NUM_PROPS                                                                             */,\
  0x4D /* START_PROP                                                                            */,\
  0x18 /* MODEM_RSSI_CONTROL2,RSSIJMP_DWN[5],RSSIJMP_UP[4],ENRSSIJMP[3],JMPDLYLEN[2],ENJMPRX[1] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_GLOBAL_CLK_CFG { \
  ...
  0x01 /* NUM_PROPS                                                              */,\
  0x01 /* START_PROP                                                             */,\
  0x00 /* GLOBAL_CLK_CFG,DIVIDED_CLK_EN[6],DIVIDED_CLK_SEL[5:3],CLK_32K_SEL[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_GLOBAL_WUT_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                               */,\
  0x04 /* START_PROP                                                                              */,\
  0x00 /* GLOBAL_WUT_CONFIG,WUT_LDC_EN[7:6],WUT_CAL_PERIOD[5:3],WUT_LBD_EN[2],WUT_EN[1],CAL_EN[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_GLOBAL_WUT_LDC { \
  ...
  0x01 /* NUM_PROPS                   */,\
  0x08 /* START_PROP                  */,\
  0x01 /* GLOBAL_WUT_LDC,WUT_LDC[7:0] */\
}
