...
// BASE_FREQUENCY = 433000000
#define RADIO_USER_INPUT_BASE_FREQUENCY 433000000
// BIT_ORDER = false
#define RADIO_USER_INPUT_BIT_ORDER FALSE
// CENTER_FREQUENCY = 433000000
#define RADIO_USER_INPUT_CENTER_FREQUENCY 433000000
// CHANNEL_NUMBER = 0
...
#define RADIO_USER_INPUT_CRYSTAL_FREQUENCY 26000000
...
// ENABLE_CRC[0] = true
#define RADIO_USER_INPUT_ENABLE_CRC[0] TRUE
// ENABLE_CRC[1] = true
...
// ENABLE_MODEM_HW_INTERRUPT = false
#define RADIO_USER_INPUT_ENABLE_MODEM_HW_INTERRUPT FALSE
...
// GPIO0 = 29
#define RADIO_USER_INPUT_GPIO0 29
// GPIO0_PULLUP = false
#define RADIO_USER_INPUT_GPIO0_PULLUP FALSE
// GPIO1 = 29
#define RADIO_USER_INPUT_GPIO1 29
// GPIO1_PULLUP = false
...
// LDC_RX_TIME_ADJUST = 1
#define RADIO_USER_INPUT_LDC_RX_TIME_ADJUST 1
// LDC_SLEEP_TIME_ADJUST = 1
#define RADIO_USER_INPUT_LDC_SLEEP_TIME_ADJUST 1
...
// MODEM_HW_INTERRUPT = 0
#define RADIO_USER_INPUT_MODEM_HW_INTERRUPT 0
// NIRQ = 0
#define RADIO_USER_INPUT_NIRQ 0
// NIRQ_PULLUP = false
#define RADIO_USER_INPUT_NIRQ_PULLUP FALSE
// PACKET_HANDELR_HW_INTERRUPT = 56
#define RADIO_USER_INPUT_PACKET_HANDELR_HW_INTERRUPT 56
// PH_FIELD_SPLIT = false
#define RADIO_USER_INPUT_PH_FIELD_SPLIT FALSE
// PKT_ALLOW_BIT_ERR = 0
...
// PKT_FIELD_LENGTH[1] = 8
#define RADIO_USER_INPUT_PKT_FIELD_LENGTH[1] 8
...
// PKT_PREAMBLE_PATTERN_LENGTH = 1
#define RADIO_USER_INPUT_PKT_PREAMBLE_PATTERN_LENGTH 1
...
// PKT_RX_FIELD_LENGTH[0] = 0
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[0] 0
// PKT_RX_FIELD_LENGTH[1] = 0
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[1] 0
...
// PKT_VARIABLE_PACKET_LENGTH_ENABLE = false
#define RADIO_USER_INPUT_PKT_VARIABLE_PACKET_LENGTH_ENABLE FALSE
...
// RFPARAM_DATA_RATE = 10000
#define RADIO_USER_INPUT_RFPARAM_DATA_RATE 10000
// RFPARAM_DEVIATION = 20000
#define RADIO_USER_INPUT_RFPARAM_DEVIATION 20000
...
// RFPARAM_ENABLE_PLL_AFC = true
#define RADIO_USER_INPUT_RFPARAM_ENABLE_PLL_AFC TRUE
// RFPARAM_IF_MODE = 2
...
// RFPARAM_MODULATION_TYPE = FSK2
#define RADIO_USER_INPUT_RFPARAM_MODULATION_TYPE FSK2
// RFPARAM_OSR_TUNE = 0
#define RADIO_USER_INPUT_RFPARAM_OSR_TUNE 0
// RFPARAM_PREAMBLE_PATTERN = 0
#define RADIO_USER_INPUT_RFPARAM_PREAMBLE_PATTERN 0
// RFPARAM_RSSI_AVERAGE = 0
#define RADIO_USER_INPUT_RFPARAM_RSSI_AVERAGE 0
...
// RX_CRC_START = false
#define RADIO_USER_INPUT_RX_CRC_START FALSE
...
// SELECTED_CHIP = si4460~revision[REVC2A]
#define RADIO_USER_INPUT_SELECTED_CHIP si4460~revision[REVC2A]
// SW_CRC_CTRL = false
...
// Modem.API_Fdev = 20000
#define CHIP_CONFIG_INPUT_MODEM_API_FDEV 20000
...
// Pkt.PKT_CONFIG1__PH_FIELD_SPLIT = false
#define CHIP_CONFIG_INPUT_PKT_PKT_CONFIG1__PH_FIELD_SPLIT FALSE
...
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_LENGTH__RX_FIELD_1_LENGTH 0
// RssiConfig.CheckThresholdAtAverage = false
#define CHIP_CONFIG_INPUT_RSSICONFIG_CHECKTHRESHOLDATAVERAGE FALSE
...
// Modem.API_freq_xo = 26000000
#define CHIP_CONFIG_INPUT_MODEM_API_FREQ_XO 26000000
...
// InterruptControl.INT_CTL_ENABLE__MODEM_INT_STATUS_EN = false
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_ENABLE__MODEM_INT_STATUS_EN FALSE
...
// RssiConfig.JumpThreshold = 255
#define CHIP_CONFIG_INPUT_RSSICONFIG_JUMPTHRESHOLD 255
// Global.GLOBAL_WUT_LDC__WUT_LDC = 1
#define CHIP_CONFIG_INPUT_GLOBAL_GLOBAL_WUT_LDC__WUT_LDC 1
...
// Modem.API_fhst = 250000
#define CHIP_CONFIG_INPUT_MODEM_API_FHST 250000
...
// RssiConfig.Average = 0
#define CHIP_CONFIG_INPUT_RSSICONFIG_AVERAGE 0
...
// Pkt.PKT_RX_FIELD_1_CRC_CONFIG__CRC_START = false
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_CRC_CONFIG__CRC_START FALSE
...
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_2_LENGTH__RX_FIELD_2_LENGTH 0
...
// RssiConfig.Latch = 0
#define CHIP_CONFIG_INPUT_RSSICONFIG_LATCH 0
...
// PowerUp.use_external_tcxo = false
#define CHIP_CONFIG_INPUT_POWERUP_USE_EXTERNAL_TCXO FALSE
...
// Modem.API_fc = 433000000
#define CHIP_CONFIG_INPUT_MODEM_API_FC 433000000
...
// Global.GLOBAL_WUT_M__WUT_M = 1
#define CHIP_CONFIG_INPUT_GLOBAL_GLOBAL_WUT_M__WUT_M 1
...
// Pkt.PKT_FIELD_1_CRC_CONFIG__CRC_ENABLE = true
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_1_CRC_CONFIG__CRC_ENABLE TRUE
...
// Modem.API_Rsymb = 10000
#define CHIP_CONFIG_INPUT_MODEM_API_RSYMB 10000
...
// Pkt.PKT_FIELD_2_LENGTH__FIELD_2_LENGTH = 8
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_2_LENGTH__FIELD_2_LENGTH 8
...
// GpioPinCfg.gpio_mode = [29, 29, 32, 33]
#define CHIP_CONFIG_INPUT_GPIOPINCFG_GPIO_MODE "[29, 29, 32, 33]"
...
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_PH_ENABLE__RX_FIFO_ALMOST_FULL_EN 0
// InterruptControl.INT_CTL_PH_ENABLE__TX_FIFO_ALMOST_EMPTY_EN = 0
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_PH_ENABLE__TX_FIFO_ALMOST_EMPTY_EN 0
...
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_MODEM_ENABLE__PREAMBLE_DETECT_EN 0
// InterruptControl.INT_CTL_MODEM_ENABLE__INVALID_PREAMBLE_EN = 0
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_MODEM_ENABLE__INVALID_PREAMBLE_EN 0
...
// Modem.API_afc_en = 1
#define CHIP_CONFIG_INPUT_MODEM_API_AFC_EN 1
...
// Pkt.PKT_LEN__DST_FIELD = 0
#define CHIP_CONFIG_INPUT_PKT_PKT_LEN__DST_FIELD 0
// Pkt.PKT_LEN_FIELD_SOURCE__SRC_FIELD = 0
#define CHIP_CONFIG_INPUT_PKT_PKT_LEN_FIELD_SOURCE__SRC_FIELD 0
...
// Global.GLOBAL_CLK_CFG__CLK_32K_SEL = 0
#define CHIP_CONFIG_INPUT_GLOBAL_GLOBAL_CLK_CFG__CLK_32K_SEL 0
...
#define CHIP_CONFIG_INPUT_MODEM_API_MODULATION_TYPE 2
// Modem.API_hi_pfm_div_mode = 1
#define CHIP_CONFIG_INPUT_MODEM_API_HI_PFM_DIV_MODE 1
